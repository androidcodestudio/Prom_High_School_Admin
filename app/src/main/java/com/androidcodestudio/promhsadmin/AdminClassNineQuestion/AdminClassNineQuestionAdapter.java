...
public class AdminClassNineQuestionAdapter extends RecyclerView.Adapter<AdminClassNineQuestionAdapter.QViewholder>{
    private List<AdminClassNineQuestionPojo> list;
    private String category;
    private DeleteListener deleteListener;

    public AdminClassNineQuestionAdapter(List<AdminClassNineQuestionPojo> list, String category, DeleteListener deleteListener) {
        this.list = list;
        ...
        private void setData(String question,String answer,int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent editintent = new Intent(itemView.getContext(), AdminClassNineAddQuestionActivity.class);
