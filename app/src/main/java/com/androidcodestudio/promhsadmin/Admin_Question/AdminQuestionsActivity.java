...
public class AdminQuestionsActivity extends AppCompatActivity {
    ...
    private AdminQuestionsAdepter _adepter;
    public static List<AdminQuestionsPojo> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _adepter = new AdminQuestionsAdepter(list, categoryName, new AdminQuestionsAdepter.DeleteListener() {
            @Override
            public void onLongClick(int position, String id) {
                new AlertDialog.Builder(AdminQuestionsActivity.this)
                        .setTitle("Delete Question")
                        .setMessage("Are you sure,you want to Delete This Question")
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                myRef.child("SETS").child(categoryName).child("question").child(id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(AdminQuestionsActivity.this, "fail to remove", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
        ...
        _add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addQuestion = new Intent(AdminQuestionsActivity.this, AddQuestionActivity.class);
        ...
        _excel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ActivityCompat.checkSelfPermission(AdminQuestionsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    selectFile();
                } else {
                    ActivityCompat.requestPermissions(AdminQuestionsActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 101);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 101) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(AdminQuestionsActivity.this, "allow first", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        if (requestCode == 102) {
            if (resultCode == RESULT_OK) {
                ...
                if (filePath.endsWith(".xlsx")) {
                    ...
                    Toast.makeText(AdminQuestionsActivity.this, "File Selected", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(AdminQuestionsActivity.this, "Chose Another Excel File", Toast.LENGTH_SHORT).show();
        ...
        myRef.child("SETS").child(categoryName)
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    list.add(new AdminQuestionsPojo(id, question, a, b, c, d, correct_ans, set));
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminQuestionsActivity.this, "error", Toast.LENGTH_SHORT).show();
                loadingDialog.dismiss();
                finish();
            }
        });
    ...
    private void readFile(Uri fileUri) {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                List<AdminQuestionsPojo> templist = new ArrayList<>();
                    ...
                    if (rowsCount > 0) {
                        for (int r = 0; r < rowsCount; r++) {
                            ...
                            if (row.getPhysicalNumberOfCells() == CELL_COUNT) {
                                ...
                                if (correct_ans.equals(a) || correct_ans.equals(b) || correct_ans.equals(c) || correct_ans.equals(d)) {
                                    ...
                                    templist.add(new AdminQuestionsPojo(id, question, a, b, c, d, correct_ans, set));
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            loadingDialog.dismiss();
                                            Toast.makeText(AdminQuestionsActivity.this, "Row No. " + (finalR + 1) + "Has No Correct Option", Toast.LENGTH_SHORT).show();
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        //loadingText.setText("Loading...");
                                        loadingDialog.dismiss();
                                        Toast.makeText(AdminQuestionsActivity.this, "Row No. " + (finalR1 + 1) + "Has Incorrect Data", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                ...
                                FirebaseDatabase.getInstance().getReference()
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            //loadingText.setText("Loading...");
                                            Toast.makeText(AdminQuestionsActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                                            return;
                                        }
                                        loadingDialog.dismiss();
                                    }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                //loadingText.setText("Loading...");
                                loadingDialog.dismiss();
                                Toast.makeText(AdminQuestionsActivity.this, "File is Empty", Toast.LENGTH_SHORT).show();
                            }
                        });
                        return;
