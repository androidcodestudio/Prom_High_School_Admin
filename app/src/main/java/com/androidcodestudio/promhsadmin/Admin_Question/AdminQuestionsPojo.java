...
public class AdminQuestionsPojo {
    private String id,question,op_one,op_two,op_three,op_four,correct_ans;
    private int set;

    public AdminQuestionsPojo(String id, String question, String op_one, String op_two, String op_three, String op_four, String correct_ans, int set) {
        this.id = id;
