...
public class AdminClassSixQuestionAdapter extends RecyclerView.Adapter<AdminClassSixQuestionAdapter.QViewholder>{
    private List<AdminClassSixQuestionPojo> list;
    private String category;
    private DeleteListener deleteListener;

    public AdminClassSixQuestionAdapter(List<AdminClassSixQuestionPojo> list, String category, DeleteListener deleteListener) {
        this.list = list;
        ...
        private void setData(String question,String answer,int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent editintent = new Intent(itemView.getContext(), AdminClassSixAddQuestionActivity.class);
