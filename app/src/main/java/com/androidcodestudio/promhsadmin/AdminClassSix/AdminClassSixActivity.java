...
public class AdminClassSixActivity extends AppCompatActivity {

    private List<AdminClassSixPojo> categories_pojos;
    private Dialog category_dialog;
    private CircleImageView _addImage;
    private EditText _categoryName;
    private Uri image;
    private String downloadurl;
    AdminClassSixAdapter categories_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_class_six);
        ...
        showSliderImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminClassSixActivity.this, AllSlideImageActivity.class);
                intent.putExtra("sliderName","ClassSixSlider");
                        ...
                        for(DataSnapshot data:dataSnapshot.getChildren()){
                            ...
                            mainslider.setItemClickListener(new ItemClickListener() {
                                ...
                                public void onItemSelected(int i) {
                                    Toast.makeText(AdminClassSixActivity.this,remoteimages.get(i).getImagePath().toString(),Toast.LENGTH_SHORT).show();
        ...
        _addBtn.setOnClickListener(view -> {
            ...
            for(AdminClassSixPojo pojo :categories_pojos){
            ...
            //upload
            if (image == null) {
                Toast.makeText(AdminClassSixActivity.this, "please select category image", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Create Class(Vi) Subjects");
        ...
        categories_adapter = new AdminClassSixAdapter(this, categories_pojos, new AdminClassSixAdapter.DeleteListener() {
            @Override
            public void onDelete(String key, int position) {

                new AlertDialog.Builder(AdminClassSixActivity.this)
                        .setTitle("Delete Category")
                        .setMessage("Are you sure,you want to Delete this category")
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                myRef.child("ClassSixCategories").child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            myRef.child("CLASS_SIX_SETS").child(categories_pojos.get(position).getName()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        ...
                                                        Toast.makeText(AdminClassSixActivity.this, "fail to remove", Toast.LENGTH_SHORT).show();
        ...
        myRef.child("ClassSixCategories").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot Snapshot : snapshot.getChildren()) {
                    //categories_pojos.add(Snapshot.getValue(AdminClassSixPojo.class));
                    categories_pojos.add(new AdminClassSixPojo(Snapshot.child("name").getValue().toString(),
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminClassSixActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.add) {
            Toast.makeText(AdminClassSixActivity.this, "Selected", Toast.LENGTH_SHORT).show();
                ...
                return imageReference.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AdminClassSixActivity.this, "problem", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
        ...
        database.getReference()
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            categories_pojos.add(new AdminClassSixPojo(_categoryName.getText().toString(), 0, downloadurl, "category" + (categories_pojos.size() + 1)));
                            categories_adapter.notifyDataSetChanged();
