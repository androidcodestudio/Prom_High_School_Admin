...
public class AdminClassTwelveQuestionAdapter extends RecyclerView.Adapter<AdminClassTwelveQuestionAdapter.QViewholder>{
    private List<AdminClassTwelveQuestionPojo> list;
    private String category;
    private DeleteListener deleteListener;

    public AdminClassTwelveQuestionAdapter(List<AdminClassTwelveQuestionPojo> list, String category, DeleteListener deleteListener) {
        this.list = list;
        ...
        private void setData(String question,String answer,int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent editintent = new Intent(itemView.getContext(), AdminClassTwelveAddQuestionActivity.class);
