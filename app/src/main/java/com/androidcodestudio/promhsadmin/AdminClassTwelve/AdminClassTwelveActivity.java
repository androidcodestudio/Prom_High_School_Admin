...
import com.androidcodestudio.promhsadmin.Admin_Category.AdminCategoriesAdapter;
import com.androidcodestudio.promhsadmin.Admin_Category.AdminCategoriesPojo;
...
public class AdminClassTwelveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_class_twelve);
        ...
        showSliderImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminClassTwelveActivity.this, AllSlideImageActivity.class);
                intent.putExtra("sliderName","ClassTwelveSlider");
                        ...
                        for(DataSnapshot data:dataSnapshot.getChildren()){
                            ...
                            mainslider.setItemClickListener(new ItemClickListener() {
                                ...
                                public void onItemSelected(int i) {
                                    Toast.makeText(AdminClassTwelveActivity.this,remoteimages.get(i).getImagePath().toString(),Toast.LENGTH_SHORT).show();
        ...
        _addBtn.setOnClickListener(view -> {
            ...
            //upload
            if (image == null) {
                Toast.makeText(AdminClassTwelveActivity.this, "please select category image", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Create Class(Xii) Subjects");
        ...
        categories_adapter = new AdminCategoriesAdapter(this, categories_pojos, new AdminCategoriesAdapter.DeleteListener() {
            ...
            public void onDelete(String key, int position) {
                ...
                new AlertDialog.Builder(AdminClassTwelveActivity.this)
                        .setTitle("Delete Category")
                        .setMessage("Are you sure,you want to Delete this category")
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                myRef.child("ClassTwelveCategories").child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                            ...
                                            myRef.child("SETS").child(categories_pojos.get(position).getName()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        ...
                                                        Toast.makeText(AdminClassTwelveActivity.this, "fail to remove", Toast.LENGTH_SHORT).show();
        ...
        myRef.child("ClassTwelveCategories").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminClassTwelveActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.add) {
            Toast.makeText(AdminClassTwelveActivity.this, "Selected", Toast.LENGTH_SHORT).show();
                ...
                return imageReference.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AdminClassTwelveActivity.this, "problem", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void UploadCategoryName() {
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        database.getReference().child("ClassTwelveCategories").child("category" + (categories_pojos.size() + 1)).setValue(map)
