...
public class AdminClassFiveQuestionAdepter extends RecyclerView.Adapter<AdminClassFiveQuestionAdepter.QViewholder>{
    private List<AdminClassFiveQuestionPojo> list;
    private String category;
    private DeleteListener deleteListener;


    public AdminClassFiveQuestionAdepter(List<AdminClassFiveQuestionPojo> list, String category, DeleteListener deleteListener) {
        this.list = list;
        ...
        private void setData(String question,String answer,int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent editintent = new Intent(itemView.getContext(), AdminClassFiveAddQuestionActivity.class);
