...
public class AdminClassTenQuestionAdapter extends RecyclerView.Adapter<AdminClassTenQuestionAdapter.QViewholder>{
    private List<AdminClassTenQuestionPojo> list;
    private String category;
    private DeleteListener deleteListener;

    public AdminClassTenQuestionAdapter(List<AdminClassTenQuestionPojo> list, String category, DeleteListener deleteListener) {
        this.list = list;
        ...
        private void setData(String question,String answer,int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent editintent = new Intent(itemView.getContext(), AdminClassTenAddQuestionActivity.class);
