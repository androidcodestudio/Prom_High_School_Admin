...
public class AdminClassSevenQuestionAdapter extends RecyclerView.Adapter<AdminClassSevenQuestionAdapter.QViewholder>{
    private List<AdminClassSevenQuestionPojo> list;
    private String category;
    private DeleteListener deleteListener;

    public AdminClassSevenQuestionAdapter(List<AdminClassSevenQuestionPojo> list, String category, DeleteListener deleteListener) {
        this.list = list;
        ...
        private void setData(String question,String answer,int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent editintent = new Intent(itemView.getContext(), AdminClassSevenAddQuestionActivity.class);
