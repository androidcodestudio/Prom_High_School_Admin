...
public class AdminClassElevenQuestionAdapter extends RecyclerView.Adapter<AdminClassElevenQuestionAdapter.QViewholder>{
    private List<AdminClassElevenQuestionPojo> list;
    private String category;
    private DeleteListener deleteListener;

    public AdminClassElevenQuestionAdapter(List<AdminClassElevenQuestionPojo> list, String category, DeleteListener deleteListener) {
        this.list = list;
        ...
        private void setData(String question,String answer,int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent editintent = new Intent(itemView.getContext(), AdminClassElevenAddQuestionActivity.class);
